...
public class Game : MonoBehaviour
{
	...
	private void Start()
	{
		...
		case 1:
			...
			break;
		case 2:
			component.sprite = Resources.Load<Sprite>("icons/icons/bird_2");
			break;
		case 3:
			component.sprite = Resources.Load<Sprite>("icons/icons/bird_3");
			break;
		case 4:
			component.sprite = Resources.Load<Sprite>("icons/icons/bird_4");
			break;
		default:
			component.sprite = Resources.Load<Sprite>("icons/icons/bird_1");
		...
		case 1:
			...
			break;
		case 2:
			overlayRender.sprite = Resources.Load<Sprite>("icons/overlays/overlay_2");
			break;
		case 3:
			overlayRender.sprite = Resources.Load<Sprite>("icons/overlays/overlay_3");
			break;
		case 4:
			overlayRender.sprite = Resources.Load<Sprite>("icons/overlays/overlay_4");
			break;
		case 5:
			overlayRender.sprite = Resources.Load<Sprite>("icons/overlays/overlay_5");
			break;
		case 6:
			overlayRender.sprite = Resources.Load<Sprite>("icons/overlays/overlay_6");
			break;
		case 7:
			overlayRender.sprite = Resources.Load<Sprite>("icons/overlays/overlay_7");
			break;
		case 8:
			...
			break;
		case 9:
			overlayRender.sprite = Resources.Load<Sprite>("icons/overlays/overlay_9");
			break;
		default:
			overlayRender.sprite = null;
			break;
		}
		...
		if (PlayerPrefs.GetInt("Setting2", 0) == 1)
		{
			...
			gameObject5.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("textures/Arrow");
	...
	private void Update()
	{
		...
		if (!pausePanel.activeSelf)
		{
			...
			foreach (GameObject gameObject6 in array5)
			{
				...
				{
					AudioSource.PlayClipAtPoint(Resources.Load<AudioClip>("sounds/Eat"), Camera.main.transform.position, PlayerPrefs.GetFloat("sfxVolume", 1f));
					Object.Destroy(gameObject6);
					score++;
					UpdateScore(score);
				}
			...
			foreach (GameObject gameObject7 in array5)
			{
				...
				{
					AudioSource.PlayClipAtPoint(Resources.Load<AudioClip>("sounds/Death"), Camera.main.transform.position, PlayerPrefs.GetFloat("sfxVolume", 1f));
					Respawn();
				}
			...
			foreach (GameObject gameObject8 in array5)
			{
				...
				{
					AudioSource.PlayClipAtPoint(Resources.Load<AudioClip>("sounds/Powerup"), Camera.main.transform.position, 0.5f * PlayerPrefs.GetFloat("sfxVolume", 1f));
					Object.Destroy(gameObject8);
					if (slownessLeft > 0f)
					{
						slownessLeft = 0f;
			...
			foreach (GameObject gameObject9 in array5)
			{
				...
				{
					AudioSource.PlayClipAtPoint(Resources.Load<AudioClip>("sounds/Slowness"), Camera.main.transform.position, 0.5f * PlayerPrefs.GetFloat("sfxVolume", 1f));
					Object.Destroy(gameObject9);
					boostLeft = 0f;
					slownessLeft = 10f;
					if (score > 0)
