...
public class Leaderboard : MonoBehaviour
{
    ...
    private IEnumerator GetTopPlayers(int showAmount)
    {
        ...
        using UnityWebRequest request = UnityWebRequest.Post("https://berrydash.lncvrt.xyz/database/getTopPlayers.php", wWWForm);
        request.SetRequestHeader("User-Agent", "BerryDashClient");
        request.SetRequestHeader("ClientVersion", "1.33");
